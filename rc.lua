...
beautiful.init(awful.util.get_configuration_dir() .. "doc-theme/theme.lua")
...
local tags_names  = {
    "~: notes", "1: text", "2: www", "3: file", "4: console", "5", "6", "7", "8", "9", "0",
...
local tags_layout = {
    ...
    lain.layout.termfair.center, -- 6
    lain.layout.termfair.center, -- 7
    lain.layout.termfair.center, -- 8
    lain.layout.termfair.center, -- 9
    lain.layout.termfair.center, -- 0
    lain.layout.termfair.center, -- Q
    awful.layout.suit.max, -- W
    awful.layout.suit.tile, -- E
    lain.layout.centerwork, -- R

    awful.layout.suit.tile, -- A
...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag(tags_names, s, tags_layout)
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey, "Control"   }, "Next",     function () awful.tag.incnmaster( 1, nil, true) end,
              {description = "increase the number of master clients", group = "layout"}),
    awful.key({ modkey, "Control"   }, "Prior",     function () awful.tag.incnmaster(-1, nil, true) end,
...
--[[
 ...
 -- Run
    ...
    awful.key({ modkey  }, "Next",  function () awful.layout.inc(awful.layout.layouts,  1) end), 
